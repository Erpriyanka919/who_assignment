...
public class Assignment_2 {
  ...
  //TC-01 - To verify the UI alignment with Mode=Random
	...
	Match m=f1.next();
		if((m.getScore()*100) == 100)
			System.out.println("No alignment issues found with Random Screen");
		f1.destroy();
	}
	else{
	 System.out.println("Alignment issues found with Random Screen");
	 }
		
  //To navigate to UI alignment with pixel_shift=100
    System.out.println("%nTC-02 - To verify the UI alignment with pixel_shift=100");
  ...
  //To navigate to UI alignment with mode=random&pixel_shift=100
    System.out.println("%nTC-03 - To verify the UI alignment with mode=random&pixel_shift=100");
  ...
  //Refresh the screen
	System.out.println("%nTC-04 - To verify the UI alignment with the base screen on selecting Refresh(F5)");
	driver.get("https://the-internet.herokuapp.com/shifting_content/menu");
  ...
  //TC-04 - To verify the UI alignment with the base screen on selecting Refresh(F5)
	...
	System.out.println("Alignment issues found found on Refresh Screen");
